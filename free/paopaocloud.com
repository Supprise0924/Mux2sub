#!MANAGED-CONFIG https://lting.cyou/link/YqLVqlvi8m9s0IlY?clash=1

#---------------------------------------------------#
## 上次更新于：2022-09-01 05:32:59
#---------------------------------------------------#
...
proxies:
  -
    ...
    port: 10010
    uuid: 702f9f37-7d32-3189-a97f-b8c89344b46c
    alterId: 0
    cipher: auto
    udp: true
    network: ws
  ...
  -
    ...
    ws-opts:
      path: /v2ray
      headers: { Host: ssru.v2.us02.2yun.win }
    ws-path: /v2ray
    ws-headers:
      Host: ssru.v2.us02.2yun.win
    tls: true
  -
  ...
  -
    ...
    ws-opts:
      path: /v2ray
      headers: { Host: test.111book.icu }
    ws-path: /v2ray
    ws-headers:
      Host: test.111book.icu
    tls: true
  -
    name: _z_test
    type: vmess
...
proxy-groups:
  -
    ...
    proxies:
      ...
      - v2ray德国01
      - v2ray新加坡01(Netflix)
      - v2ray新西伯利亚01(俄罗斯Netflix)
      - v2ray新西伯利亚02(俄罗斯Netflix)
      - v2ray日本01(Netflix|Abema|...)
      - v2ray日本02(Netflix|Abema|...)
      - v2ray日本03
      - v2ray日本05(Netflix|Abema|...)
      - v2ray智利01
      - v2ray法国01
      - v2ray澳大利亚01
      - v2ray美国02
