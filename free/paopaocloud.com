#!MANAGED-CONFIG https://lting.cyou/link/u2yDoFnOMLldd3An?clash=1

#---------------------------------------------------#
## 上次更新于：2022-10-08 09:02:08
#---------------------------------------------------#
...
proxies:
  -
    ...
    port: 10010
    uuid: fd1aefb4-50ae-34f7-b0d5-8439cd948ce1
    alterId: 0
    cipher: auto
    udp: true
    network: ws
  ...
  -
    ...
    tls: true
  -
    name: _v2ray-4zl-日本02(Netflix|Abema|...)
    type: vmess
